...
myDate <- '080920' 
RoiDirectoryPath <- "~/Desktop/In vivo imaging/RStudio/ROI/Aging/ROI/"
CorrespTimePointDPIPath <- "~/Desktop/in vivo imaging/RStudio/ROI/Aging/Correspondence/"

# For neurogenic clone only
myDate <- '170820' 
RoiDirectoryPath <- "~/Desktop/In vivo imaging/RStudio/ROI/Aging/ROI (neurogenic clone)/"
CorrespTimePointDPIPath <- "~/Desktop/in vivo imaging/RStudio/ROI/Aging/Correspondence/"
...
myLegend <-  c("R","NR","N","A","Cell_Death","Uncertain")
